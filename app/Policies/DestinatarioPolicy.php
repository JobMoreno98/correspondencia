...
class DestinatarioPolicy
{
    ...
    {
        return $user->can('view_any_destinatario');
    }
    ...
    {
        return $user->can('view_destinatario');
    }
    ...
    {
        return $user->can('create_destinatario');
    }
    ...
    {
        return $user->can('update_destinatario');
    }
    ...
    {
        return $user->can('delete_destinatario');
    }
     ...
     */
    public function replicate(User $user, Destinatario $destinatario): bool
    {
